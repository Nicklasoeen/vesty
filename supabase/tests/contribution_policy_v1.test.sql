...
select *
from tests.open_investment_day_v1((select club_id from owner_club));
...
select *
from tests.open_investment_day_v1((select club_id from owner_club), '2026-10-05 10:00:00+00');
...
select *
from tests.open_investment_day_v1((select club_id from other_club));
