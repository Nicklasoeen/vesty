...
import { AppText, Stat, Surface } from '@/ui';
...
export function HomePortfolioCard({ presentation, historyByRange }: HomePortfolioCardProps) {
  ...
  return (
    <Surface bordered elevated style={{ padding: spacing.md + 2, borderRadius: radius.xl }}>
      ...
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', marginTop: 2 }}>
        <AppText variant="supporting">Total value across all your clubs</AppText>
      ...
      >
        <Stat value={formatHomeNokFromMinor(presentation.investedMinor)} label={HOME_PORTFOLIO_STAT_LABELS[0]} />
